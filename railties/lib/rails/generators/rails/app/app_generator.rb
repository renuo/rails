...
module Rails
  ...
  class AppBuilder
    ...
    def bin
      exclude_pattern = Regexp.union([(/thrust/ if skip_thruster?), (/rubocop/ if skip_rubocop?), (/brakeman/ if skip_brakeman?), (/bundle-audit/ if skip_bundle_audit?)].compact)
    ...
    def config
      ...
      inside "config" do
        ...
        template "bundler-audit.yml" unless skip_bundle_audit?
